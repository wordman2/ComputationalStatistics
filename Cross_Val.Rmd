...
- Im Alter unterscheiden sich die Splits nicht stark zwischen Trainings- und Testdatensatz. In Split #1 sind etwas ältere Personen im Trainings- als im Testset.
- Im Trainingsdatensatz in Split #1 und #2 befinden sich mehr Frauen als im Trainingsdatensatz. In Split #3 befinden sich mehr Frauen im Testdatensatz als im Trainingsdatensatz.
- Die Verteilungen der Minderheiten sind in Split #1 und #2 in Trainings- und Testdatensatz ausgeglichen. In Split #3 sind Minderheiten im Trainingsdatensatz unterrepräsentiert.
- Wie zu erwarten, ist aufgrund der Unterrepräsentation von Minderheiten bei Split #3 die Fremdenfeindlichkeit im Trainingsdatensatz höher als im Testdatensatz.
- Bei Betrachtung des 75%-Quantils ist der IQ im Testdatensatz ist etwas geringer als im Trainingsdatensatz bei Split #1 und #2.
- In Split #1 und deutlich in Split #2 ist die Zustimmung für Trump höher im Test höher als im Training.
- Nach den MSEs zu urteilen, sind die lineare Regressionsmodelle, die mit die Trainingsdaten von Split #2 und #3 trainiert wurden, machen präzisere Vorhersagen als das Modell von Split #1. Aus den Verteilungen der Splits lässt sich nicht ableiten, warum in Split #1 der MSE am höchsten ist.
...
Die MSEs der k-fachen Cross Validierung zeigt mit k=5 und k=10 keine großen Differenzen auf. Auch zur LOO-CV ist kein großer Unterschied zu sehen. Mit der k-fachen Cross Validierung lässt sich zwar Rechenleistung sparen, bei dieser Datensatzgröße ist das aber nicht notwendig, von daher ist in diesem Beispiel die LOO-CV zu bevorzugen.
