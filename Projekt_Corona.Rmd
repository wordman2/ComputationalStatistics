...
begegnen ist die Wahrscheinlichkeit sich anzustecken geringer. Eine
...
plot(mod_sis)
legend(x="topright",legend=c("Susceptible", "Infected"), col=c(1,2))
```
